  ...
  return (
    <Layout navigation={navigation}>
      <div className="bg-white rounded-xl shadow-sm p-8 text-center">
        <FiFileText className="w-16 h-16 text-primary-600 mx-auto mb-4" />
        <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('contentManagement')}</h2>
        <p className="text-gray-600">
          {language === 'en' ? 'Content management coming soon!' : 'إدارة المحتوى قريباً!'}
        </p>
      </div>
    </Layout>
  )
